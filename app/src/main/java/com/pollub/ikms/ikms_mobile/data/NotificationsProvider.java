...
public class NotificationsProvider  extends ContentProvider {
    ...
    static {
        uriMatcher.addURI(NotificationsContract.CONTENT_AUTHORITY, NotificationsContract.PATH_NOTIFICATIONS, NOTIFICATIONS);
        //single row of the table;  # - accepts any integer number
        uriMatcher.addURI(NotificationsContract.CONTENT_AUTHORITY, NotificationsContract.PATH_NOTIFICATIONS + "/#", NOTIFICATIONS_ID);

        uriMatcher.addURI(NotificationsContract.CONTENT_AUTHORITY, PATH_SENDERS, SENDERS);
        //single row of the table;  # - accepts any integer number
        uriMatcher.addURI(NotificationsContract.CONTENT_AUTHORITY, PATH_SENDERS + "/#", SENDERS_ID);
    }
